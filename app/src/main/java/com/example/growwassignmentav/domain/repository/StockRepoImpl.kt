...
import com.example.growwassignmentav.data.mappers.toDomainDaily
import com.example.growwassignmentav.data.mappers.toDomainIntraday
import com.example.growwassignmentav.data.mappers.toDomainMonthly
import com.example.growwassignmentav.data.mappers.toDomainWeekly
...
import com.example.growwassignmentav.domain.model.TimeRange
...
class StockRepositoryImpl(
    ...
    override suspend fun searchStocks(query: String): List<com.example.growwassignmentav.domain.model.SearchResult> {
